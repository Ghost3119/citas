...
$queryUsuarios = $conn->prepare('SELECT id, nombre FROM usuarios WHERE rol = "empleado"');
...
<head>
    ...
    <link rel="stylesheet" href="./styles/agregar_empleado.css">
...
<body>
    ...
    <main class="main">
        <form class="form" method="POST" action="agregar_empleado.php?sucursal_id=<?php echo $sucursal_id; ?>">
            ...
            <input class="add-empleado" type="submit" name="add" value="Agregar Empleado">
        </form>
    </main>
</body>
